...
2. Progressive - Hindi Premise and English Hypothesis (Image Included)
"""
...
np.array(hidden_context_eng_img).dump(open('/content/gdrive/My Drive/Hidden_Context_English_Image_Concat.npy', 'wb'))
...
hidden_context_eng_img = np.load('/content/gdrive/My Drive/COLING 2020/Hidden_Context_English_Image_Concat.npy', allow_pickle=True)
